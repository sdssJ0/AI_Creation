...
// Complete script.js with thumbnail roadmap tags
const code = `const el = (id) => document.getElementById(id);
    ...
    roadmap.forEach(function(step) {
        ...
        if (sv.length > 0) {
            ...
            sv.forEach(function(v) {
                ...
                const bvid = v.bvid;
                html += '<div class="roadmap-thumb-tag" onclick="scrollToVideo(' + "\\'" + "' + bvid + " + "'" + "\\'" + ')">';
                html += '<img class="roadmap-thumb-img" src="' + "\\'" + ' + (v.pic || ' + "\\'" + "\\'" + ') + ' + "\\'" + '" loading="lazy" onerror="this.remove()">';
                html += '<span class="order-badge-tag">' + "\\'" + ' + order + ' + "\\'" + '</span>';
                html += '<span class="roadmap-thumb-title">' + "\\'" + ' + escapeHtml(v.title) + ' + "\\'" + '</span></div>';
            });
            html += "</div>";
        }
        html += "</div>";
