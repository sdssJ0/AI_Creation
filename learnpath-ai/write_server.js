const fs = require("fs");
const path = "D:/ai_creation2/learnpath-ai/server.py";

const code = `import json, sys, os, urllib.request, urllib.parse, re, concurrent.futures, time
...
def analyze_learning_goal(query):
    prompt = (
        ...
        + "要求：difficulty只能是beginner/intermediate/advanced，keywords填3个搜索关键词，roadmap 3-5个学习步骤"
    )
...
class LearnPathHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if os.path.isfile(fp):
            ...
            mime = {".html":"text/html;charset=utf-8",".css":"text/css;charset=utf-8",".js":"application/javascript"}
...
console.log("server.py written successfully");
